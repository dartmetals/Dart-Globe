...
//   const [flipDirection, setFlipDirection] = useState<'left' | null>(null);
...
//       // Wait 2 seconds to clearly show the last blog
//       setTimeout(() => {
//         setIsResetting(true);
//         setAutoPlay(false);
        
//         // Show all images with equal width (20% each) for 3 seconds with no titles
//         setTimeout(() => {
//           setCurrentIndex(0);
//           setIsResetting(false);
//           setAutoPlay(true);
//         }, 3000); // Equal width display time
//       }, 2000); // Extra time to show last blog clearly
//     }
...
//       // Trigger animation for shape only
//       setTimeout(() => {
...
//     if (!isFlipping && !isAnimating && !isResetting && index !== currentIndex) {
//       pauseAutoPlay();
//       setIsFlipping(true);
//       setIsAnimating(true);
//       setNextIndex(index);
...
//                       let width = '20%'; // Default equal width
                      
//                       if (!isResetting) {
//                         // Normal mode - one image is 60%, others are 20%
//                         width = index === currentIndex ? '60%' : '20%';
//                       }
//                       // When resetting, all are 20%
...
//                             {/* Title hidden during reset, shows only for current index when not resetting */}
//                             {!isResetting && (
//                               <div 
