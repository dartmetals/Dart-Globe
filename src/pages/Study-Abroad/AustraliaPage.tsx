...
<section className="relative h-[40vh] sm:h-[76vh] md:h-[80vh] text-white overflow-hidden bg-white">
  ...
  Study in <br />
  <span className="block ml-12 sm:ml-12 md:ml-16 lg:ml-16 mt-2">Australia</span>
</h1>
  </div>
</div>
</section>
  ...
  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 text-left mt-8 mb-4 w-[92%] mx-auto">Why Choose the Australia for Your Education?</h2>
